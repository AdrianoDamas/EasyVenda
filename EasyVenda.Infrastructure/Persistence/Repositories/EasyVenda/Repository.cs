...
namespace _EasyVenda.Infrastructure.Persistence.Repositories._EasyVenda
{
    public class Repository<T> : IRepository<T> where T : class
    {
        protected DbSet<T> _dbSet;
        protected _EasyVendaDbContext _dbContext;

        public Repository(_EasyVendaDbContext dbContext)
        {
