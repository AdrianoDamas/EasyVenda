...
using _EasyVenda.Infrastructure.Persistence.Context;
using _EasyVenda.Core.Entities;
using FluentAssertions;

namespace _EasyVenda.IntegrationTests.DatabaseTests
{
    public class VendaIntegrationTests : IAsyncLifetime
    {
        private readonly MsSqlContainer _dbContainer;
        private _EasyVendaDbContext _dbContext;
        ...
        public async Task InitializeAsync()
        {
            ...
            var options = new DbContextOptionsBuilder<_EasyVendaDbContext>()
                .UseSqlServer(_dbContainer.GetConnectionString())
                .Options;

            _dbContext = new _EasyVendaDbContext(options);
